...
export const PARTICIPANT_PRESETS = [
  ...
  },
  {
    ...
    description: "Greek moon goddess to Luna's Roman: Pi-backed Kimi K2.7 Code reviewer with high thinking (via OpenRouter).",
    kind: "pi",
    model: "openrouter/moonshotai/kimi-k2.7-code",
    thinking: "high",
    skillsPolicy: "default",
  ...
  },
  {
    ...
    name: "Daedalus",
    label: "Pi Kimi K2.7 Code",
    description: "Greek master craftsman: Pi-backed Kimi K2.7 Code reviewer with high thinking (via OpenRouter).",
    kind: "pi",
    model: "openrouter/moonshotai/kimi-k2.7-code",
    thinking: "high",
    skillsPolicy: "default",
